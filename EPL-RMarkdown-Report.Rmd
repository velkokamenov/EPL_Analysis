...
date: "May 12, 2019, 38 Rounds Played"
output:
...
```{r load data}
footballersData= fread("./Input Data/All_GW_Files_DF.csv", na.strings=c("NULL",""), encoding = "UTF-8")
matchData= fread("./Input Data/EPL_Match_Results.csv", na.strings=c("NULL",""))
positionIDs = fread("./Input Data/Player_Position_IDs.csv", na.strings=c("NULL",""))
playersTeamsAndPositions = fread("./Input Data/PlayerTeamsPositions.csv", na.strings=c("NULL",""), encoding = "UTF-8")
teamIDs = fread("./Input Data/Team_IDs.csv", na.strings=c("NULL",""))

# Fix character encoding issues in player names
footballersData$name <- iconv(footballersData$name, from = "latin1", to = "UTF-8")
playersTeamsAndPositions$PlayerName <- iconv(playersTeamsAndPositions$PlayerName, from = "latin1", to = "UTF-8")
...
# Create scatter plots with trend lines and R-squared values
