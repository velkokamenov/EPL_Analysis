...
```{r load data}
footballersData= fread("./Input Data/All_GW_Files_DF.csv", na.strings=c("NULL",""))
...
playersTeamsAndPositions = fread("./Input Data/PlayerTeamsPositions.csv", na.strings=c("NULL",""))
